...
public class BookServiceTests {
    ...
    void shouldGetBookByISBN(){
        Optional<Book> bookOptional = Optional.of(bookRepository.findBookByIsbn("978-0-385-48451-0")
                .orElseThrow(() -> new NoSuchElementException("Book not found")));

        Book expectedBook = bookOptional.get();
        Book actualBook = bookService.getBookByISBN("978-0-385-48451-0");
